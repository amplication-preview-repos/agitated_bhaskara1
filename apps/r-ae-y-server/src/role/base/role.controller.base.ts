...
export class RoleControllerBase {
  ...
  async findAppUsers(
    ...
    const query = plainToClass(AppUserFindManyArgs, request.query);
    const results = await this.service.findAppUsers(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/appUsers")
  @nestAccessControl.UseRoles({
    resource: "Role",
    action: "update",
    possession: "any",
  })
  async connectAppUsers(
    @common.Param() params: RoleWhereUniqueInput,
    @common.Body() body: AppUserWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      appUsers: {
        connect: body,
  ...
  @common.Delete("/:id/appUsers")
  @nestAccessControl.UseRoles({
    resource: "Role",
    action: "update",
    possession: "any",
  })
  async disconnectAppUsers(
    @common.Param() params: RoleWhereUniqueInput,
    @common.Body() body: AppUserWhereUniqueInput[]
  ): Promise<void> {
    const data = {
